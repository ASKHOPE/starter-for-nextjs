...
const $$Agenda = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Program Preview" }, { "default": ($$result2) => renderTemplate`${id ? renderTemplate`${renderComponent($$result2, "PreviewAgenda", PreviewAgenda, { "client:load": true, "agendaId": id, "client:component-hydration": "load", "client:component-path": "/Users/hosanna/Documents/GitHub/mychurchcallings/src/components/pages/PreviewAgenda", "client:component-export": "PreviewAgenda" })}` : renderTemplate`${maybeRenderHead()}<div class="flex items-center justify-center min-h-[60vh] text-on-surface-variant font-bold">
No Agenda Selected
</div>`}` })}`;
}, "/Users/hosanna/Documents/GitHub/mychurchcallings/src/pages/preview/agenda.astro", void 0);

const $$file = "/Users/hosanna/Documents/GitHub/mychurchcallings/src/pages/preview/agenda.astro";
