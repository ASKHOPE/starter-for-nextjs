...
const $$Export = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Data Export" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "DataExport", DataExport, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Admin/Documents/Repo Proj/calling/src/components/tools/DataExport", "client:component-export": "DataExport" })} ` })}`;
}, "C:/Users/Admin/Documents/Repo Proj/calling/src/pages/tools/export.astro", void 0);

const $$file = "C:/Users/Admin/Documents/Repo Proj/calling/src/pages/tools/export.astro";
