...
import { Search, ArrowRight, Bookmark, MessageSquare, Music, Book, ChevronRight } from 'lucide-react';
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-12 pb-32", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center text-center gap-10", children: [
      /* @__PURE__ */ jsxs("div", { className: "max-w-2xl", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-4xl md:text-5xl font-black text-primary tracking-tight", children: "Sacred Resources" }),
        /* @__PURE__ */ jsx("p", { className: "text-on-surface-variant mt-3 text-lg font-medium", children: "Access essential content for study and teaching." })
      ] }),
