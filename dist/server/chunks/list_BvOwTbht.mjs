...
const $$List = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": title || "Sacred Library" }, { "default": ($$result2) => renderTemplate`${collection ? renderTemplate`${renderComponent($$result2, "LibraryList", LibraryList, { "client:load": true, "collection": collection, "title": title, "client:component-hydration": "load", "client:component-path": "/Users/hosanna/Documents/GitHub/mychurchcallings/src/components/pages/LibraryList", "client:component-export": "LibraryList" })}` : renderTemplate`${maybeRenderHead()}<div class="flex items-center justify-center min-h-[60vh] text-on-surface-variant font-bold">
Category Not Found
</div>`}` })}`;
}, "/Users/hosanna/Documents/GitHub/mychurchcallings/src/pages/resources/list.astro", void 0);

const $$file = "/Users/hosanna/Documents/GitHub/mychurchcallings/src/pages/resources/list.astro";
