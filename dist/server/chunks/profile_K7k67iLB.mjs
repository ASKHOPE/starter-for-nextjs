...
import { User, Camera, Sparkles, MapPin, Calendar, Mail, Shield, Clock, Bell, LogOut } from 'lucide-react';
import { a as actions } from './server_UlLFQcGP.mjs';
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex flex-col md:flex-row items-center gap-8 md:gap-12", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "text-center md:text-left space-y-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
            ...
            /* @__PURE__ */ jsx("h1", { className: "text-4xl md:text-5xl font-black tracking-tighter", children: "Bishop David Smith" }),
            /* @__PURE__ */ jsx("p", { className: "text-blue-100/80 text-xl font-medium italic", children: "Oak Hills 4th Ward • Stake of Zion" })
          ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 space-y-8", children: [
        /* @__PURE__ */ jsxs("section", { className: "bg-surface-container-lowest p-8 rounded-[2.5rem] border border-outline-variant/30 shadow-xl shadow-slate-200/40 space-y-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsx(ProfileCard, { icon: Mail, label: "Contact Email", value: "bishop.smith@ward.org" }),
            /* @__PURE__ */ jsx(ProfileCard, { icon: Shield, label: "Access Level", value: "Stake Administrator" }),
            /* @__PURE__ */ jsx(ProfileCard, { icon: Clock, label: "Session Expiry", value: "In 4 Hours" }),
            /* @__PURE__ */ jsx(ProfileCard, { icon: Bell, label: "Notification Mode", value: "Critical Alerts Only" })
          ] })
        ] }),
