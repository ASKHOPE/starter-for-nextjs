import './server_CG6lBRbX.mjs';
import * as z from 'zod/v4';
import { Client, Storage, Databases, Account, ID, Query } from 'node-appwrite';
import { d as defineAction } from './server_dYLE_H8d.mjs';

async function createAdminClient() {
  const client = new Client().setEndpoint("https://sgp.cloud.appwrite.io/v1").setProject("69fe3c0300373d8bbb90").setKey(undefined                                );
  return {
    get account() {
