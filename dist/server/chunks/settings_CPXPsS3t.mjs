...
const $$Settings = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "App Settings" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "AppSettings", AppSettings, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Admin/Documents/Repo Proj/calling/src/components/tools/AppSettings", "client:component-export": "AppSettings" })} ` })}`;
}, "C:/Users/Admin/Documents/Repo Proj/calling/src/pages/tools/settings.astro", void 0);

const $$file = "C:/Users/Admin/Documents/Repo Proj/calling/src/pages/tools/settings.astro";
